...
const Grainient = ({
  ...
  // ✅ FIXED: was `grainient-container` (position:relative, no size)
  //           now  `grainient-bg`       (position:fixed, inset:0, z-index:0)
  return <div ref={containerRef} className={`grainient-bg ${className}`.trim()} aria-hidden="true" />;
};
